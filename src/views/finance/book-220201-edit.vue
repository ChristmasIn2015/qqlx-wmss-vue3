<template>
    <div class="q-pl-xs q-mb-sm">
        ...
        <div class="text-option text-primary q-mt-sm">
            ...
            订单，您已确认实际付出货款 {{ nowAmount }} / {{ BookStore.editor.amount }} 元。 （{{ ((nowAmount * 100) / BookStore.editor.amount).toFixed(2) }}%）
        </div>
    </div>
    ...
    <div class="row items-stretch q-mb-sm">
        <div class="col-8">
            <q-table
                ...
                :columns="[
                    ...
                    { name: 'amountBookOfOrder', field: 'amountBookOfOrder', label: '付款确认' },
        ...
        <div class="col-4 q-pl-sm">
            <q-card class="full-height column">
                <q-card-section class="text-h5 text-weight-bold">付款信息 </q-card-section>
                ...
                <q-card-section class="text-grey text-body1">
                    ...
                    <div class="q-mt-sm">财务负责人已经打出采购货款，到供应商的指定银行账户。至此，我们需要您确认这笔货款，是用于哪些采购单据的商品交易。</div>
                </q-card-section>
                <q-separator></q-separator>
                <q-card-section class="text-grey text-body1">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 text-right text-body1">
                            <span class="text-blue text-bold">{{ nowAmount.toLocaleString("zh", { minimumFractionDigits: 2 }) }} </span>
                            /
                            <span class="">
                                {{ BookStore.editor.amount.toLocaleString("zh", { minimumFractionDigits: 2 }) }}
                            </span>
    ...
    <picker-book-order :type="ENUM_ORDER.PURCHASE" :is-invoice="false" />
</template>
