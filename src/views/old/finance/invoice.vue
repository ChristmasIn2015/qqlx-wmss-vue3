    ...
    <div class="q-pb-sm row">
        <q-btn-group class="q-mr-sm">
            <q-btn
                ...
                @click="
                    () => {
                        InvoiceStore.setEditor(InvoiceStore.getSchema(ENUM_BOOK_TYPE.YSZK_VAT, ENUM_BOOK_DIRECTION.JIE));
                        startIndex = -1;
                        endIndex = -1;
                        InvoiceStore.get(1);
                    }
            ...
            <q-btn
                ...
                @click="
                    () => {
                        InvoiceStore.setEditor(InvoiceStore.getSchema(ENUM_BOOK_TYPE.YFZK_VAT, ENUM_BOOK_DIRECTION.DAI));
                        startIndex = -1;
                        endIndex = -1;
                        InvoiceStore.get(1);
                    }
        ...
        <q-btn
            ...
            @click="
                () => {
                    InvoiceStore.setEditor(InvoiceStore.getSchema(InvoiceStore.invoiceSearch.type, InvoiceStore.invoiceSearch.direction));
...
import { useBookStore } from "@/stores/wmss/book/book.js";
...
const toEdit = (invoice: InvoiceInView) => {
    ...
    InvoiceStore.setEditor(_invoice);
