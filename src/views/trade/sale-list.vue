                                ...
                                <q-card square>
                                    ...
                                    <q-card-section>
                                        <div class="row text-body1">
                                            ...
                                            <span class="col-6 text-right text-weight-bold">{{ props.row.joinManager?.nickname || "无" }}</span>
                                        </div>
                                    ...
                                    <q-card-section>
                                        ...
                                        <div class="text-body1 text-grey q-mt-xs" v-if="props.row.joinBookOfOrder">
                                            ...
                                            <div class="row q-mt-xs" v-for="BO in props.row.joinBookOfOrder">
                                                <span class="col text-grey" style="white-space: break-spaces">{{ BO.joinBook?.keyOrigin || "客户异常" }} </span>
                                                <span
                                                    class="col text-right text-teal text-weight-bold text-underline cursor-pointer"
                                                    @click="$router.push(`/wmss/finance/book-1002?code=${BO.joinBook?.code}`)"
                                                >
                                    ...
                                    <q-card-section class="text-body2 text-grey" style="white-space: break-spaces">
                                        <div>1.复核后首先将会通知仓库装货，并生成发货单</div>
                                        <div>2.您可以取消复核，请注意这样不会影响旧的发货单，需要前往仓库订单中取消旧的发货订单</div>
                                    </q-card-section>
                                    <q-card-actions>
                                        <q-space></q-space>
                                        <q-btn
